...
public interface IDataSet<T extends Entry> {
     ...
     * values of the DataSet and the value-sum.
     */
    void addEntryOrdered(@NotNull T e);
     ...
     * be removed.
     */
    boolean removeEntry(@NotNull T e);
     ...
     */
    void setValueFormatter(@NotNull IValueFormatter f);
     ...
     */
    void setValueTypeface(@Nullable Typeface tf);
     ...
     */
    void setIconsOffset(@NotNull MPPointF offset);
