...
public class DataSetTest {
    ...
    public void testGetEntryForXValue() {
        ...
        Entry closest = set.getEntryForXValue(17, Float.NaN, DataSet.ROUNDING_CLOSEST);
        assertEquals(15, closest.getX(), 0.01f);
        assertEquals(5, closest.getY(), 0.01f);

        closest = set.getEntryForXValue(17, Float.NaN, DataSet.ROUNDING_DOWN);
        assertEquals(15, closest.getX(), 0.01f);
        assertEquals(5, closest.getY(), 0.01f);

        closest = set.getEntryForXValue(15, Float.NaN, DataSet.ROUNDING_DOWN);
        assertEquals(15, closest.getX(), 0.01f);
        assertEquals(5, closest.getY(), 0.01f);

        closest = set.getEntryForXValue(14, Float.NaN, DataSet.ROUNDING_DOWN);
        assertEquals(10, closest.getX(), 0.01f);
        assertEquals(10, closest.getY(), 0.01f);

        closest = set.getEntryForXValue(17, Float.NaN, DataSet.ROUNDING_UP);
        assertEquals(21, closest.getX(), 0.01f);
        assertEquals(5, closest.getY(), 0.01f);

        closest = set.getEntryForXValue(21, Float.NaN, DataSet.ROUNDING_UP);
        assertEquals(21, closest.getX(), 0.01f);
        assertEquals(5, closest.getY(), 0.01f);

        closest = set.getEntryForXValue(21, Float.NaN, DataSet.ROUNDING_CLOSEST);
        assertEquals(21, closest.getX(), 0.01f);
        assertEquals(5, closest.getY(), 0.01f);
    }
    ...
    public void testGetEntryForXValueWithDuplicates() {
        ...
        Entry closest = set.getEntryForXValue(0, Float.NaN, DataSet.ROUNDING_CLOSEST);
        assertEquals(0, closest.getX(), 0.01f);
        assertEquals(10, closest.getY(), 0.01f);

        closest = set.getEntryForXValue(5, Float.NaN, DataSet.ROUNDING_CLOSEST);
        assertEquals(5, closest.getX(), 0.01f);
        assertEquals(80, closest.getY(), 0.01f);

        closest = set.getEntryForXValue(5.4f, Float.NaN, DataSet.ROUNDING_CLOSEST);
        assertEquals(5, closest.getX(), 0.01f);
        assertEquals(80, closest.getY(), 0.01f);

        closest = set.getEntryForXValue(4.6f, Float.NaN, DataSet.ROUNDING_CLOSEST);
        assertEquals(5, closest.getX(), 0.01f);
        assertEquals(80, closest.getY(), 0.01f);

        closest = set.getEntryForXValue(7, Float.NaN, DataSet.ROUNDING_CLOSEST);
        assertEquals(7, closest.getX(), 0.01f);
        assertEquals(100, closest.getY(), 0.01f);

        closest = set.getEntryForXValue(4f, Float.NaN, DataSet.ROUNDING_CLOSEST);
